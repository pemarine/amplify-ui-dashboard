...
import HvacCombo from '../HvacCombo';
                   ...
                   */
                    >
                        ...
                        <Grid templateColumns="1fr 1fr 1fr" gap="9px">
                            ...
                            <View>
                                <Meter value={(parseFloat(vessel.OutsideHum || '0') / 10)} title='Outdoor humidity' minValue={0} maxValue={100} unit='% Rh' />
                ...
                >
                    ...
                    <View>
                        ...
                        >
                            ...
                            <View>
                                <HvacCombo
                                    titleTotal='HVAC Total'
                                    subtitleTotal='Power'
                                    valueTotal='0'
                                    titlePercent='HVAC Percent'
                                    subtitlePercent='Actual Power in % of prev. average'
                                    valuePercent='0'
