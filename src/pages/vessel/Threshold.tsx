...
export const background = '#083450';
    ...
    <div>
      <svg width={width} height={height}>
        ...
        <Group left={margin.left} top={margin.top}>
          <GridRows scale={temperatureScale} width={xMax} height={yMax} stroke="#204861" />
          <GridColumns scale={timeScale} width={xMax} height={yMax} stroke="#204861" />
          <line x1={xMax} x2={xMax} y1={0} y2={yMax} stroke="#204861" />
          <AxisBottom
            top={yMax} 
            scale={timeScale} 
