...
export default function VesselCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setHVAC_Avg_Power(initialValues.HVAC_Avg_Power);
    setEnergy_Last_Day(initialValues.Energy_Last_Day);
    setErrors({});
  };
  const validations = {
    clientID: [],
